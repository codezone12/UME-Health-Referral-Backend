...
const referralConfirmation = async (title, name, email, subject, pdfLink) => {
    ...
    <body>
      ...
      <p>A new referral request has been submitted by <strong>${title} ${name}</strong>. You can see a copy of the referral by <a href=${pdfLink}>clicking here</a>. UME Health will aim to respond to the referral request within 48 hours.</p>
